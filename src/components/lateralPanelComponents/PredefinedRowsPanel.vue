    ...
    <div class="tool-panel lateral-panel-section-padding" v-if="expanded">
      <div>
        <div class="tool-panel__group">
          <div class="draggable-tool" draggable="true" @dragstart="startDrag('threeSeven')">
            <img src="_editor/images/three-seven.png" class="filter-invert" alt="3/7" />
            <p>3/7</p>
          </div>
          <div class="draggable-tool" draggable="true" @dragstart="startDrag('sevenThree')">
            <img src="_editor/images/seven-three.png" class="filter-invert" alt="7/3" />
            <p>7/3</p>
          </div>
          <div class="draggable-tool" draggable="true" @dragstart="startDrag('two-column')">
            <img
              src="_editor/images/two_column.png"
              class="filter-invert fit-content"
              :style="{ 'max-width': '70%' }"
              alt="two column"
            />
            <p>2 columnas</p>
          </div>
          <div class="draggable-tool" draggable="true" @dragstart="startDrag('three-column')">
            <img
              src="_editor/images/three_column.png"
              class="filter-invert fit-content"
              :style="{ 'max-width': '80%' }"
              alt="three column"
            />
